...
export default function LoginScreen(): JSX.Element {
  ...
  const UserIcon = () => (
    <Svg width={16} height={16} viewBox="0 0 24 24" fill="#00D1FF">
      <Path d="M12 2a3 3 0 0 1 3 3v1a3 3 0 0 1-6 0V5a3 3 0 0 1 3-3zm0 12c-4 0-8 2-8 5v3h16v-3c0-3-4-5-8-5z" />
      <Circle cx="5" cy="8" r="2" />
      <Circle cx="19" cy="8" r="2" />
      <Path d="M2 20v-1c0-2 2-3.5 4-4m12 0c2 0 4 2 4 4v1" />
    </Svg>
  );
  ...
  return (
    ...
    {/* CAMPOS */}
    <TextInput
      className="h-12 border mb-4 px-4 py-2 rounded"
      style={{
    ...
    />
    <View className="mb-4">
      <Button title="Ingresar" color="#004d32" onPress={handleLogin} />
    </View>
